...
boolean isCategoryLogged(ModelInstance *comp, int categoryIndex);

static boolean invalidNumber(ModelInstance *comp, const char *f, const char *arg, int n, int nExpected) {
    if (n != nExpected) {
